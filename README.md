...
## Conclusions
As the accuracy of the model increases, the loss decreases. The final model has an accuracy of 85% and a loss of 0.57. The model is able to predict the class of the lesion with a high accuracy. Augmenting the data and countering class imbalance helped in improving the accuracy of the model. Increasing the number of epochs will result in increased accuracy and decreased loss.
